...
import 'package:dx_table/src/dx_table.dart';
import 'package:dx_table/src/renderer/flutter_table_border.dart';
import 'package:flutter/foundation.dart';
import 'package:flutter/rendering.dart' hide TableBorder;
...
class RenderTable extends RenderBox {
  ...
  RenderTable({
    ...
    List<List<RenderBox>>? children,
        ...
        _dxTableController = dxTableController,
  ...
  void performLayout() {
    ...
    _dxTableController.setTableComputationData(
      columnWidths: widths,
      rowHeight: _rowTops[1],
    );
